...
public class DAOMagazineImpl implements DAOMagazine {
    ...
    private final String GET_MAGAZINE_NAME_CATEGORY = "SELECT * FROM revista WHERE nombre_revista LIKE ? AND nombre_categoria=? AND estado_revista='ACEPTADA'";
    private final String GET_MAGAZINE_NAME = "SELECT * FROM revista WHERE nombre_revista LIKE ? AND estado_revista='ACEPTADA'";

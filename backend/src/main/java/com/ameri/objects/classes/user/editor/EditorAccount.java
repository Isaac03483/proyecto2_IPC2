...
public class EditorAccount {
    ...
    public EditorAccount(int accountRecord, String editorName, String subscriberName, int magazineRecord, BigDecimal totalPay, BigDecimal descuento, BigDecimal ganancia, String payDate) {
